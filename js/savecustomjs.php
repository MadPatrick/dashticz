...
$customPath = $customDir . '/custom.js';
...
if (file_put_contents($customPath, $content, LOCK_EX) === false) {
    dashticz_json_error(500, 'Kon custom.js niet schrijven. Controleer of de webserver schrijfrechten heeft op de map "custom/" (bijv. chmod 775 custom/).');
}
