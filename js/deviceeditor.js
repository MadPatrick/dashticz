...
var DashticzDeviceEditor = (function () {
  ...
  function _widgetFromReference(reference) {
    ...
    var translatedTitles = {
      ...
      f1: t.f1_title || 'F1 - Next event',
      f1events: t.f1events_title || 'F1 - All events',
    ...
    var catalog = {
      ...
      widget_f1: { id: 'f1', title: translatedTitles.f1 },
      widget_f1events: { id: 'f1events', title: translatedTitles.f1events },
