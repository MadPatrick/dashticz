...
(function (window, document) {
  ...
  var nl = {
    ...
    targetHelp: 'De pulldown toont beschikbare geconfigureerde devices met naam, IDX en block-key. Text-devices worden bovenaan getoond.',
  ...
  var en = {
    ...
    targetHelp: 'The dropdown lists available configured devices by name, IDX and block key. Text devices are listed first.',
  ...
  function captureTextBase(target) {
    ...
    textBaseValues[target] = {
      hadOwn: !!(
        definition &&
        Object.prototype.hasOwnProperty.call(definition, 'title')
      ),
