...
test('modern dark theme is portable and documented', () => {
  ...
  assert.match(theme, /inset 0 0 0 var\(--main-border-width\) var\(--border-color-inactive\)/);
  ...
  assert.match(theme, /\.transbg select[\s\S]*border: 1px solid var\(--border-color-inactive\) !important/);
